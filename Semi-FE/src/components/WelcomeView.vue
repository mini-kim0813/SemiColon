...
<!--              <a class='cta-link' href='#'>친구야</a>-->
<!--            </div>-->
<!--            <div class='master-container-scroller_item'>-->
<!--              <a class='cta-link' href='#'>형아</a>-->
<!--            </div>-->
<!--            <div class='master-container-scroller_item'>-->
<!--              <a class='cta-link' href='#'>누나야</a>-->
<!--            </div>-->
<!--            <div class='master-container-scroller_item'>-->
<!--              <a class='cta-link' href='#'>언니야</a>-->
<!--            </div>-->
<!--            <div class='master-container-scroller_item'>-->
<!--              <a class='cta-link' href='#'>동생아</a>-->
<!--            </div>-->
<!--            <div class='master-container-scroller_item'>-->
<!--              <a class='cta-link' href='#'>아들아</a>-->
<!--            </div>-->
<!--            <div class='master-container-scroller_item'>-->
<!--              <a class='cta-link' href='#'>딸아</a>-->
<!--            </div>-->
          </div>
          <div>SemiColon에 온 걸 환영해</div>
        </h1>
      </div>
    </div>
  </section>
